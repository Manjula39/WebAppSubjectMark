...
namespace WebAppSubjectMark.Controllers
{
    ...
    public class SubjectsController : ControllerBase
    {
        ...
        public SubjectsController(SubjectsDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Subjects>> PostSubjects(Subjects subjects)
        {
          if (_context.Subjects == null)
          {
              return Problem("Entity set 'SubjectsDbContext.Subjects'  is null.");
          }
